...
#'
#' @family printing function provided by ub
#' @export
cat0 = function(..., file = "", sep = "", fill = FALSE, pad = FALSE, padding = ' ', pad_side = 'right', 
  labels = NULL, append = FALSE, flush = TRUE, flush_cycle = 1, envir = ub_environment(), 
...
#' @rdname cat0
#' @export
flush_console = function(flush = TRUE, flush_cycle = 1, envir = ub_environment()) {
