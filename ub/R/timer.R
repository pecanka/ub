...
#' @rdname clock
#' @export
start_clock = function(announce=TRUE, envir=ub_environment(), lead="", what="", out="") {
...
#' @rdname clock
#' @export
read_clock = function(announce=TRUE, envir=ub_environment()) {
...
#' @rdname clock
#' @export
stop_clock = function(announce=TRUE, envir=ub_environment(), lead="", what="", out="") {
...
#' @name timners
#' @export
start_timer = function(timer_name = NULL, announce = TRUE, envir = ub_environment(), lead = NULL, 
  ...
  if(is.null(timer_name)) {
    timer_name = timer_name_n(length(timers) + 1)
  }
...
#' @rdname timners
#' @export
stop_timer = function(timer_name = NULL, announce = TRUE, envir = ub_environment(), lead = NULL, 
    what = "timer", out = NULL, format = identity) {
...
#' @rdname timners
#' @export
read_timer = function(timer_name = NULL, announce = TRUE, start = FALSE, envir = ub_environment()) {
...
#' @rdname timners
#' @export
stop_all_timers = function(envir = ub_environment()) {
  timers = get_timers(envir=envir)
  sapply(rev(names(timers)), stop_timer, envir=envir)
  return(invisible(NULL))
}

get_timers = function(var_name = '.timers', envir = ub_environment()) {
  get0(var_name, envir = envir, ifnotfound = list())
}

save_timers = function(timers, var_name = '.timers', envir = ub_environment()) {
