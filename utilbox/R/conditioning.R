...
#'
#' `ifelsem` is an extension of [base::ifelse] which allows non-scalar
#' response. It returns a list. An attempt at simplifying the response
#' is made when `simplify=TRUE`.
#'
#' @export
...
#' 
#' Credit goes to Moody_Mudskipper (https://github.com/moodymudskipper), 
#' Code from https://stackoverflow.com/questions/30604107/r-conditional-evaluation-when-using-the-pipe-operator
#' 
